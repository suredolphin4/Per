...
<!-- 工具栏 -->
<div id="tb">
    <a id="lw_statusfilter" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-stutafilter', plain:true" onclick="salStaAdvancedSearch()">高级查询</a>
    <a id="export" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-export', plain:true" onclick="salStaExportExcel()">导出</a>
    ...
    <a id="caculate" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-audit', plain:true" onclick="salCalculate()">计算工资</a>
</div>

<!-- 高级搜索 -->
<div id="salStaAdvancedSearch_dialog" class="easyui-dialog" data-options="region:'north',title:'高级检索',buttons:'#ps_advanced_search_btn',border:false,closed:true,modal:true"
