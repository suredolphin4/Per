...
<head>
    ...
    <link rel="stylesheet" href="css/axure_rp_page.css" type="text/css" />
...
<body>
<div id="base" class="easyui-layout" data-options="fit:true" style="height:100%; width:100%;">
        ...
        <div id="u22" class="u22cla">
            ...
            <div class="page-container">
                ...
                <form id="reg-form" method="post"  action="${pageContext.request.contextPath}/loginAction!ValidateUser.action">
                        ...
                        <div style="margin-bottom: 25px;">
                            <input type="text" name="usercode" id="usercode" class="easyui-numberbox"
                                   easyform="length:1-16;char-normal;real-time;" message="请输入1-6位字符用户名"
                                   easytip="disappear:lost-focus;theme:red;" ajax-message="用户名已存在!"
                                   placeholder="请输入您的用户名！" onclick="reEnterLoginInfo()" />
                        </div>
                        <div style="margin-bottom: 20px;">
                            <input type="password" name="pwd" id="pwd" easyform="length:6-16;" message="密码必须为6—16位"
                                   easytip="disappear:lost-focus;theme:red;" placeholder="请输入您的用户密码！" onclick="reEnterLoginInfo()" />
                        </div>
