...
public class SalaryStatistic extends BaseModel {
    ...
    public void setWriting_second_count(Integer writing_second_count) {
    ...
    public void setNational_map_type(String national_map_type) {
