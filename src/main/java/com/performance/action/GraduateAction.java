...
@Action(value = "graduateAction", results = { 
@Result(name = "toGraduate", location = "/performance/modules/graduate/graduate.jsp") ,
@Result(name = "toGraduateEdit", location = "/performace/jsglEdit.jsp") ,
})
@Namespace("/")
@ParentPackage("basePackage")
public class GraduateAction extends BaseAction<Yj> implements SessionAware,UserAware, ModelDriven<Yj> {

	private  User userObj;
	private Map<String, Object> sessionMap;
	private Yj graduate = new Yj();
	...
	public GraduateServiceI graduateService;
	public GraduateServiceI getGraduateService() {
		return graduateService;
	}

	@Autowired
	public void setGraduateService(GraduateServiceI graduateService) {
	...
	public String toGraduateEdit() {

		return "toGraduateEdit";
	}
	...
	public void add() {
		...
		try {
			...
			Yj r = graduateService.save(graduate);
			j.setSuccess(true);
			j.setMsg("添加成功！");
			j.setObj(r);
	...
	public void edit(){
		...
		try {
			Yj r = graduateService.edit(graduate);
			j.setSuccess(true);
			j.setMsg("修改成功！");
			j.setObj(r);
		}catch(DataIntegrityViolationException e){
