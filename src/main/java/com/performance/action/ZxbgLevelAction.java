...
@Namespace("/")
@Action(value = "zxbgLevelAction")
public class ZxbgLevelAction extends BaseAction implements ModelDriven<User> {
	...
	private static final Logger logger = Logger.getLogger(ZxbgLevelAction.class);
