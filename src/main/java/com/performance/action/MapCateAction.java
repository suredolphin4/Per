...
@Namespace("/")
@Action(value = "mapCateAction")
public class MapCateAction extends BaseAction implements ModelDriven<User> {
	...
	private static final Logger logger = Logger.getLogger(MapCateAction.class);
