...
@Namespace("/")
@Action(value = "zlLevelAction")
public class ZlLevelAction extends BaseAction implements ModelDriven<User> {
	...
	private static final Logger logger = Logger.getLogger(ZlLevelAction.class);
