...
@Namespace("/")
@Action(value = "ghgradeAction")
public class GhgradeAction extends BaseAction implements ModelDriven<User> {
	...
	private static final Logger logger = Logger.getLogger(GhgradeAction.class);
