...
import com.performances.model.TAchievetransScore;
...
@Transactional
@Service("AchievetransService")
public class AchievetransServiceImpl extends BaseServiceImpl implements AchievetransServiceI {
	private BaseDaoI<TAchievetrans> yjDao;

	private static final  String tableName = "t_achievetrans";
	private String hsql;
	private Map<String, Object> params;

	public BaseDaoI<TAchievetrans> getYjDao() {
		return yjDao;
	}

	@Autowired
	public void setYjDao(BaseDaoI<TAchievetrans> lwDao) {
		this.yjDao = lwDao;
	}

	@Autowired
	private ImportExcelServiceI<TAchievetrans> _importExcel;

	@Override
	public Achievetrans save(Achievetrans lw) {
		TAchievetrans t = new TAchievetrans();
	...
	@Override
	public DataGrid datagrid(Achievetrans lw) {
		// TODO Auto-generated method stub
		DataGrid dg = new DataGrid();
		String hql = "from TAchievetrans t ";
		Map<String, Object> params = new HashMap<String, Object>();
		hql = addWhere(lw, hql, params);
		String totalHql = "select count(*) " + hql;
		hql = addOrder(lw, hql);
		List<TAchievetrans> l = yjDao.find(hql, params, lw.getPage(), lw.getRows());
		List<Achievetrans> nl = new ArrayList<Achievetrans>();
		changeModel(l, nl);
	...
	private void changeModel(List<TAchievetrans> l, List<Achievetrans> nl) {
		if (l != null && l.size() > 0) {
			for (TAchievetrans t : l) {
				Achievetrans r = new Achievetrans();
				try
				{
	...
	private void changeModel(List<TAchievetrans> l, List<Achievetrans> nl, String usercode, List<String> usercodes) {
		if (usercode.equals("") && usercodes == null) {		//1.管理员
			...
			for (TAchievetrans t : l) {
				...
				if(t.getScore() != null){
					...
					try {
					for( TAchievetransScore score : t.getScore())
					{
							if(score!=null){
	 ...
	 * @return
	 */
	private String addOrder(Achievetrans lw, String hql) {
	...
	private String addWhere(Achievetrans lw, String hql, Map<String, Object> params) {
...
//		}
	...
	@Override
	public DataGrid datagrid(Achievetrans lw, String username, List<String> usernames) {
		// TODO Auto-generated method stub
		DataGrid dg = new DataGrid();
	...
	public void remove(String ids) {
		...
		String hql = "delete TAchievetrans t where t.id in (";
	...
	@Override
	public Achievetrans edit(Achievetrans lw) {
		// TODO zhengxuebing
		TAchievetrans tlw = yjDao.get(TAchievetrans.class, lw.getId());
	...
	@Override
	public List<TAchievetrans> findEntityByHQL(String hql, Object[] objects) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public void ThesisByPoi(FileInputStream fis) {
		...
		try {
			AchievetransImportEvent<TAchievetrans> importEvent = new AchievetransImportEvent<TAchievetrans>();
			_importExcel.setEventProxy(importEvent);
			_importExcel.ImportExcelToDB("t_achievetrans", fis);
	...
	public String exportExcel(){
		return _importExcel.exportExcel("Achievetrans", tableName, hsql, params);
	}
	
	public class AchievetransImportEvent<T> implements ImportExcelEventI<T>{
	...
	public boolean  removeAll() {
		String hql = "delete TAchievetrans t ";
		try{
			yjDao.executeHql(hql);
			return true;
		}catch(Exception e){
